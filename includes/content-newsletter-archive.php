...
?>
<div id="newsletter-archive" class="popup-page newsletter-archive-content section-content-wrap" style="--section-color:<?php 
    $color = get_field('section_colour',$newsletter_archive->ID) ? get_field('section_colour',$newsletter_archive->ID) : '#e6e6e6';
    echo $color;
    ?>">
    <a href="<?php echo home_url();?>" class="close-popup close-x"><svg viewBox="0 0 34.94 35.38"><polygon points="34.94 3.65 31.1 0 17.57 13.87 4.18 0.05 0.38 3.84 13.82 17.62 0 31.59 3.74 35.38 17.42 21.41 31.06 35.33 34.9 31.59 21.12 17.62 34.94 3.65"/></svg></a>   
    <h1><?php 
